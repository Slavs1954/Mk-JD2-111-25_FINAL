package by.it_academy.jd2.mail.storage;
...
import by.it_academy.jd2.mail.storage.repository.MailRepository;
...
public class MailStorage implements IMailStorage {
    ...
    public boolean isVerified(String mail) {
        MailEntity mailEntity = mailRepository.findByUser_MailAndVerifiedTrue(mail).orElseThrow();
